...
export default function App() {
  ...
  return (
    <div className=" border-[2px]">
      <div className=" bg-gray-200 w-[350px] h-[87vh] overflow-x-auto ">
    <Input
      label=""
      variant="bordered"
      ...
      <div>
      <Accordion >
      <AccordionItem key="1" aria-label="Route Settings" subtitle="" title="Route Settings">
        {defaultContent}
      </AccordionItem>
      </Accordion>
      </div>
...
<div>
<Input type="Homepage" label="HomePage"  className="text-white bg-gray-200 flex items-center w-13 my-3 ml-4 " />
</div>
...
<div className="border-none rounded-none my-4">
      <Accordion >
      <AccordionItem key="1" aria-label="Visibility" subtitle="" title="Visibility">
        {defaultContents}
        <Progress aria-label="Loading..." value={60} className="max-w-md"/><Input type="text" placeholder="1"/>
      </AccordionItem>
      </Accordion>
      </div>
      <div className="border-none rounded-none my-4">
