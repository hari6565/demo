  ...
  return (
    <div className="mr-52">
      <div className="flex font-bold gap-2">
        <h1 className="font-bold my-4">StoryBoard</h1>
      ...
      <div className="block border border-black p-10 w-[1000px] h-96 "></div>
      <div className="flex justify-end">
        <Button className=" fixed bottom-0 right-0 z-10" onPress={onOpen}>
          <FaSearchPlus />
        </Button>
